                ...
                <Row className="justify-content-center">
                    <Col className="col-12 col-md-10 col-lg-6">
                        <div className="section-title text-center">
                            <h3><Trans>NexGen Preguntas Frecuentes</Trans></h3>
                    ...
                    <Col className="col-12 col-lg-10 offset-lg-1">
                        ...
                        <Accordion defaultActiveKey="0" flush>
                            ...
                            <Accordion.Item eventKey="4">
                                <Accordion.Header as="h5">
                                    <Trans>¿Qué es exactamente la deducción fiscal NexGen?</Trans>
                                </Accordion.Header>
                                <Accordion.Body>
                                    <div className="section-title">
                                        <h4><Trans>¿Qué es la deducción fiscal NexGen?</Trans></h4>
                                        <p><Trans>La deducción fiscal NexGen es una reducción en el monto de impuestos que debes pagar en tu declaración de la renta por realizar obras de rehabilitación de ventanas con nuestra empresa. A continuación, te explicamos cómo funciona y cómo puedes beneficiarte de ella.</Trans></p>
                                    </div>
                                    <h5><Trans>¿Cómo se aplica la deducción fiscal NexGen?</Trans></h5>
                                    ...
                                    <h5><Trans>Diferencias entre deducción fiscal NexGen y subvención NexGen:</Trans></h5>
                                    <ul>
                                        <li><strong><Trans>Deducción fiscal NexGen:</Trans></strong>
                                            <ul>
                                        ...
                                        <li><strong><Trans>Subvención NexGen:</Trans></strong>
                                            <ul>
                                    ...
                                    <h5><Trans>Importancia de la deducción fiscal NexGen:</Trans></h5>
                                    <ul>
                                        <li><strong><Trans>Ahorro en impuestos:</Trans></strong> <Trans>La deducción fiscal NexGen es beneficiosa porque te permite reducir tu carga impositiva, lo cual puede ser significativo dependiendo del monto de la deducción.</Trans></li>
                                    ...
                                    <ul>
                                        <li><strong><Trans>Documentación:</Trans></strong> <Trans>Es importante conservar toda la documentación y justificantes de los gastos realizados para poder aplicar correctamente la deducción fiscal NexGen.</Trans></li>
