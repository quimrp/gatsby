...
const Header = (props) => {
    ...
    const getLocalizedLink = (path) => {
        const lang = i18n.language || 'es'; // Default to 'en' if language is not available
        return `/${lang}${path}`;
    };
                            ...
                            <div className="op-mobile-menu col-lg-10 p-0 d-lg-flex align-items-center justify-content-end" role="button" tabIndex={0} onClick={handleMobileMenu}>
                                ...
                                <ul className="nav-menu d-lg-flex flex-wrap list-unstyled justify-content-center">
                                    <li className="nav-item">
                                        <Link to={getLocalizedLink("/#top-page")} className={props.nav === "home" ? 'nav-link js-scroll-trigger active' : 'nav-link js-scroll-trigger'}>
                                            <span>{t('Inicio')}</span>
                                        </Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link to={getLocalizedLink("/#overview")} className="nav-link js-scroll-trigger">
                                    ...
                                    <li className="nav-item">
                                        <Link to={getLocalizedLink("/#pricing")} className="nav-link js-scroll-trigger">
                                            <span>{t('Precios')}</span>
                                        </Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link to={getLocalizedLink("/#contact")} className={props.nav === "contact" ? 'nav-link js-scroll-trigger active' : 'nav-link js-scroll-trigger'}>
