...
import VidrioCamara from '~images/price-table/vidrio-camara.jpeg';
import CajaPersiana from '~images/price-table/caja-persiana.jpeg';
import Cta from './Cta';
        ...
        <Row className="row align-items-center pricing-plans">
          ...
          <Col className="col-12 col-lg-4 res-margin">
            <div className="price-table">
              ...
              <img src={SingleWelcome} alt="" className="price-image" />
              ...
              <div className="section2">
                ...
                <img src={VidrioCamara} alt="" className="price-image" />
                <ul className="list-unstyled plan-list">
              ...
              <div className="section2">
                ...
                <img src={CajaPersiana} alt="" className="price-image" />
                <ul className="list-unstyled plan-list">
              ...
              <Link className="btn" to={getLocalizedLink("/#contact")}>
                <Trans>+ INFO</Trans>
              </Link>
            </div>
          </Col>
